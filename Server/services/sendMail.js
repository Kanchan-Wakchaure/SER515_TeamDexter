...
module.exports.sendEmail = function (req, res) {
    ...
    fetchID().then(function (IdList) {
        for (var i = 0; i < IdList.length; i++) {
          ...
          <p><strong>Hello ${firstName}!!</strong></p><p>Here is a list of popular movies for this week. Find showtimes of your favourite movie at <a href="http://findmyshow.herokuapp.com">FindMyShow</a> and book your tickets now!!</p>
          <div width=500px height=250px>
            <ul>
            <img src="https://image.tmdb.org/t/p/w500//wrFpXMNBRj2PBiN4Z5kix51XaIZ.jpg"  width=150 height =250px/>
          <img src="https://image.tmdb.org/t/p/w500//i91mfvFcPPlaegcbOyjGgiWfZzh.jpg"  width=150 height =250px/>
          <img src="https://image.tmdb.org/t/p/w500//x1txcDXkcM65gl7w20PwYSxAYah.jpg"  width=150 height =250px/>
          <img src="https://image.tmdb.org/t/p/w500//2uNW4WbgBXL25BAbXGLnLqX71Sw.jpg"  width=150 height =250px/>
              <img src="https://image.tmdb.org/t/p/w500//ptSrT1JwZFWGhjSpYUtJaasQrh.jpg"  width=150 height =250px/>
               <img src="https://image.tmdb.org/t/p/w500//lNkDYKmrVem1J0aAfCnQlJOCKnT.jpg"  width=150 height =250px/>
            </ul>
          </div>
          <div>
